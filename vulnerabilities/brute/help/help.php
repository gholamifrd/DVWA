...
<p>&nbsp;</p>
<h3>سطح بالا</h3>
<p>در این‌جا از یک "نشانه ضد جعل درخواست فرا وبگاهی" (anti Cross-Site Request Forgery (CSRF) token) استفاده شده‌است. یک باور اشتباه قدیمی وجود دارد که این می‌تواند جلوی حملات بی‌رحمانه را بگیرد. این‌گونه نیست. این مرحله هم‌چنین مرحله متوسط را با استفاده از زمان‌های تصادفی میان ۲ و ۴ ثانیه هنگام ورودهای ناموفق بهبود داده است. هدف از این کار، تلاش برای گمراه‌ساختن هرگونه پیش‌بینی از طریق زمان پاسخ است.</p>
...
<p>&nbsp;</p>
<h3>سطح غیرممکن</h3>
<p>در مرحله غیرممکن،حمله بی‌رحمانه (و شمارش کاربران) نبایستی ممکن باشد. توسعه دهنده یک قابلیت "مسدود کردن" اضافه کرده‌است ، به گونه‌ای که اگر ۵ تلاش برای ورود ناموفق در ۱۵ دقیه اخیر انجام‌ شده‌باشد، کاربر تحریم‌شده امکان ورود نخواهد داشت.</p>
<p>اگر کاربر مسدودشده، حتی با پسورد درست تلاش برای ورود انجام دهد، صفحه اعلام خواهد کرد که نام کاربری یا رمز عبور اشتباه است. این حالت دانستن تمایز بین این‌ که کاربری با نام وارد شده در سیستم، با رمز‌عبور داده‌شده وجود دارد ندارد و یا این‌که کاربر مسدود شده است، غیرممکن می‌سازد.</p>
<p>این می‌تواند با وجود شخصی که مکررا تلاش برای ورود به‌ حساب شخص‌ دیگری انجام دهد، منجر به "رد سرویس" (Denial of Service - DoS) گردد. این مرحله می‌تواند با قراردادن شخص نفوذگر به لیست‌سیاه (به‌عنوان نمونه آی‌پی، آدرسو یا کشور شخص موردنظر) بهبود پیدا کند.</p>
</div>
</td>
</tr>
</tbody>
